...
<body>
    <div class="container mt-4">
        <h2>View Employees  
            ...
            <a href="../dashboard.php" class="btn btn-primary btn-sm">Go Home</a> </h2>
        <table class="table">
            <thead>
                <tr>
                    <th>Employee ID</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <a href="edit.php?id=<?php echo $employee['EMPLOYEEID']; ?>" class="btn btn-primary btn-sm mr-2">Edit</a>
                    <a href="delete.php?id=<?php echo $employee['EMPLOYEEID']; ?>" class="mc btn btn-danger btn-sm mr-3">Delete</a>
